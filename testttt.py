...
# without shuffling (in that case fix the random state (say to 42) for reproductibility)
...
svr = svm.SVC()
clf_linear = GridSearchCV(svr, parameters, n_jobs=-1)
...
svr_poly = svm.SVC()
clf_poly = GridSearchCV(svr_poly, parameters, n_jobs=-1)
